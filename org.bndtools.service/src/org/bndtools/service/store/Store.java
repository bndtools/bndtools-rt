...
public interface Store<T> {
	...
	/**
	 * Performs optimistic locking for updating a document in the database. The method acts is similar to 
	 * {@link Store#find(Object)}, except that if the element was modified 
	 * since it was retrieved from the database, a {@code ConcurrentModificationException} is thrown
